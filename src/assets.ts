...
export namespace Images {
    ...
    export class EnemyEnemyShip {
        ...
        static getPNG(): string { return require('assets/enemy/enemy_ship.png'); }
    }
    ...
    export class Piratetiles {
        ...
        static getPNG(): string { return require('assets/piratetiles.png'); }
    }
    ...
    export class WaterTile {
        ...
        static getPNG(): string { return require('assets/water_tile.png'); }
    }
}
...
export namespace JSON {
    export class Map {
        ...
        static getJSON(): string { return require('assets/map.json'); }
    }
}
